...
function () {
  function jFetch(baseUrl, options) {
    ...
    _defineProperty(this, "beforeSendFunc", function (data, headers) {
      return {
        data: data,
        headers: headers
      };
  ...
  _createClass(jFetch, [{
    ...
    value: function common(path, data, method) {
      ...
      if (data) {
        var _this$beforeSendFunc = this.beforeSendFunc(JSON.stringify(_data)),
            _data = _this$beforeSendFunc.data,
            _this$beforeSendFunc$ = _this$beforeSendFunc.headers,
            headers = _this$beforeSendFunc$ === void 0 ? {} : _this$beforeSendFunc$,
            _this$beforeSendFunc$2 = _this$beforeSendFunc.mode,
            mode = _this$beforeSendFunc$2 === void 0 ? 'cors' : _this$beforeSendFunc$2;
